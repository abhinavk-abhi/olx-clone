...
const Details = () => {
    ...
    const itemContext = ItemsContext()
  ...
  return (
    <div>
      ...
      <div className='flex flex-col relative w-full ' >
          ...
          <p className='p-1 pl-0 sm:pb-0 wrap-break-word text-ellipsis overflow-hidden w-full '>{item?.description} </p>
      ...
      <Sell setItems={(itemContext).setItems} toggleSellModal={toggleSellModal} />
