...
const Login = ({toggleModal,status}) => {
  return (
    <div>
        ...
        <div className='p-6 pl-2 pr-2 bg-white'>
          ...
          <Carousel slide={false} theme={{
            ...
            <div className='flex flex-col items-start justify-center'>
              <img className='w-24 pb-5 ' src={guitar} alt="" />
              <p style={{ color : "#002d34" }} className='w-60 sm:w-72 text-center pb-5 font-semibold' >
                Help us become one of the safest place to buy and sell.
              </p>
            </div>
            <div className='flex flex-col items-center justify-center'>
              <img className='w-24 pb-5 ' src={love} alt="" />
              <p style={{ color : "#002d34" }} className='w-60 sm:w-72 text-center pb-5 font-semibold' >
                Close deals from the comfort of your home.
              </p>
            </div>
            <div className='flex flex-col items-end justify-center'>
              <img className='w-24 pb-5 ' src={avatar} alt="" />
              <p style={{ color : "#002d34" }} className='w-60 sm:w-72 text-center pb-5 font-semibold' >
                Keep all your favorite in one place.
              </p>
            </div>
        ...
        <ModalBody className='bg-white h-96 p-0 rounded-none'>

        <div className='w-100vh p-6 pt-0 bg-amber-200'>
          <div className='w-100  flex  items-center justify-center rounded-md border-2 border-solid border-gray-300 p-5 relative h-8 cursor-pointer active:bg-teal-100'>
